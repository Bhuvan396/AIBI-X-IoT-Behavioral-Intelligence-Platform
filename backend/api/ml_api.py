...
class InferenceRequest(BaseModel):
    device_id: str
    features: dict # key-value pairs of the feature vector
...
def get_anomaly_score(req: InferenceRequest):
    ...
    # Isolation Forest specific: higher is more anomalous when negated
    # Using the same logic as in AnomalyDetector class
...
def explain_prediction(device_id: str):
    # This endpoint would typically pull from data/explanations.csv 
    # for the latest prediction of the given device
